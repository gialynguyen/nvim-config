...
_G.packer_plugins = {
  ...
  ["cmp-tabnine"] = {
    loaded = true,
    path = "/Users/gialynguyen/.local/share/nvim/site/pack/packer/start/cmp-tabnine",
  ...
  ["telescope-file-browser.nvim"] = {
    loaded = true,
    path = "/Users/gialynguyen/.local/share/nvim/site/pack/packer/start/telescope-file-browser.nvim",
