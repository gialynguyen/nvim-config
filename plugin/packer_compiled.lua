...
_G.packer_plugins = {
  ...
  ["vim-buffer-history"] = {
    loaded = true,
    path = "/Users/gialynguyen/.local/share/nvim/site/pack/packer/start/vim-buffer-history",
